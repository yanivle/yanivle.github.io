...
export default class Renderer {
    constructor() {
        this.light_source = new Vec3(0, 0, 400);
    }
    ...
    draw(triangle, context, normal_light = false) {
        ...
        normal.normalize();
        let light_source = new Vec3(1000, 1000, -600);
        // let light_vec = this.light_source.sub(triangle.center);
        let light_vec = light_source.sub(triangle.center);
        light_vec.normalize();
        ...
        // }
        let diffuse_component = Math.max(diffuse_light * cos_angle, 0);
