...
Et voilà - the model learned a new concept!
...
I spent a couple of fun weeks in 2022 with Dani Valevski, Matan Kalman, and our other collaborators, experimenting with this idea, which we call [UniTune](https://arxiv.org/abs/2210.09477) and wrote about [here](https://arxiv.org/abs/2210.09477).

For example, consider this photo of Matan and I from [the first blog we published on Google Duplex in 2018](https://research.google/blog/google-duplex-an-ai-system-for-accomplishing-real-world-tasks-over-the-phone/):
