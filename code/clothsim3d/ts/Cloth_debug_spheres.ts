...
const type = 0;
const sphere_mesh1 = Mesh.BuildSphere(0, type);
sphere_mesh1.scale(100);
const sphere_mesh2 = Mesh.BuildSphere(1, type);
sphere_mesh2.scale(100);
const sphere_mesh3 = Mesh.BuildSphere(2, type);
sphere_mesh3.scale(100);
const sphere_mesh4 = Mesh.BuildSphere(3, type);
sphere_mesh4.scale(100);
const sphere_mesh5 = Mesh.BuildSphere(4, type);
sphere_mesh5.scale(100);
const sphere_mesh6 = Mesh.BuildSphere(5, type);
sphere_mesh6.scale(100);
...
export default class Cloth {
  ...
  draw(context:CanvasRenderingContext2D):void {
    // sphere.draw(context);
    sphere_mesh1.render(this.renderer, context);
    sphere_mesh2.render(this.renderer, context);
    sphere_mesh3.render(this.renderer, context);
    sphere_mesh4.render(this.renderer, context);
    sphere_mesh5.render(this.renderer, context);
    sphere_mesh6.render(this.renderer, context);
  ...
  simulate(delta_time):void {
    ...
    mesh_center.x = 150;
    mesh_center.y = 150;
    sphere_mesh1.recenter(mesh_center);
    mesh_center.x += 250;
    sphere_mesh2.recenter(mesh_center);
    mesh_center.x += 250;
    sphere_mesh3.recenter(mesh_center);
    mesh_center.x = 150;
    mesh_center.y += 250;
    sphere_mesh4.recenter(mesh_center);
    mesh_center.x += 250;
    sphere_mesh5.recenter(mesh_center);
    mesh_center.x += 250;
    sphere_mesh6.recenter(mesh_center);
