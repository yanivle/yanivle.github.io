...
export default class ParticleSystem {
  ...
  satisfy_constraints(external_constraint:Constraint) {
  ...
  accumulate_forces(external_force:FixedForce, delta_time) {
    this.joints.forEach(joint => {
      joint.force.izero();
  ...
  simulate(external_force:FixedForce, external_constraint:Constraint, delta_time):void {
